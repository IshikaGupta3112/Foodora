...
function App() {
  return (
    <div>
      <Router>
        <Routes>
          <Route path="/buyer" exact element={<Navbar />}></Route>
          ...
          <Route path="/otp2" exact element={<Otp2 />}></Route>
          <Route path="/password" exact element={<Password />}></Route>
          <Route path="/home" exact element={<Home />}></Route>
          <Route path="/contact" exact element={<Contactus />}></Route>
          <Route path="/newadd" exact element={<NewAddress />}></Route>
          <Route path="/veradd" exact element={<Verifyadd />}></Route>
          ...
          <Route path="/sellerlogin" exact element={<SellerLogin />}></Route>
          <Route path="/sellerfrg" exact element={<SellerFrg />}></Route>
          <Route path="/sellerfrgotp" exact element={<SellerFrgOtp />}></Route>
          <Route
            path="/sellerresetpwd"
            exact
            element={<SellerResetPwd />}
          ></Route>
          <Route path="/sellersignup" exact element={<SellerSignup />}></Route>
          <Route
            path="/sellersignupotp"
            exact
            element={<SellerSignupOtp />}
          ></Route>
          <Route path="/restrauntadd" exact element={<RestrauntAdd />}></Route>
          <Route path="/foodadd" exact element={<FoodAdd />}></Route>
